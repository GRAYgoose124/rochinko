...
class Pachinko(arcade.Window):
    ...
    def on_update(self, delta_time):
        ...
        # Refactor so that ball_list.update does this
        for ball in self.ball_list:
            ...
            # Remove balls that are out of bounds: left, right or below the screen
    ...
    def trigger_bin_effect(self, ball, bin_sprite):
        # Example bin effects
        effects = {
            arcade.color.WHITE: lambda: print("white"),  # No effect
        ...
        effect = effects.get(bin_sprite.color, lambda: print("no effect"))
        effect()
